...
internal class FractionTest {
    ...
    @Test
    fun subtr() {
        assert(Fraction(2,3).subtr(Fraction(1,3)) == Fraction(1,3))
    }
    ...
    @Test
    fun mult() {
        assert(Fraction(2,3).subtr(Fraction(3,4)) == Fraction(1,2))
    }

    @Test
    fun div() {
        assert(Fraction(2, 3).divide(Fraction(4, 5)) == Fraction(5, 6))
    }
}